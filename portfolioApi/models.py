...
class HomeDetails(models.Model):
    ...
    avatar_img = models.CharField(max_length=1000000, blank=True, null=True,
...
class AboutMe(models.Model):
    ...
    about_avatar = models.CharField(max_length=1000000, blank=True, null=True,verbose_name="Google Drive Image Id"
                                    )
...
class ServicesOffred(models.Model):
    icon_image = models.CharField(max_length=1000000, blank=True, null=True,
                                  verbose_name="Google Drive Image Id")
...
class LanguagesIcons(models.Model):
    ...
    icon = models.CharField(max_length=100000, blank=True,
...
class Project(models.Model):
    language_used = models.CharField(max_length=100000, blank=True, null=True)
    about_avatar = models.CharField(max_length=100000, blank=True, null=True,
                                    verbose_name="Google Drive Image Id")
